...
- For grids-as-graphs, the "nodes" are cells and edges are the 4 (or 8) neighbors — most grid traversal problems (see [BFS & DFS](../bfs-dfs/README.md)) are just this in disguise.
